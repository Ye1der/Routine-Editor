  ...
  return(
      <div onClick={ClickPapelera} className={` ${clickTrash ? 'translate-y-96 opacity-0 scale-0' : ' translate-y-0 opacity-100' } ${renderTrash ? 'left-[50%] -translate-x-[50%]' : 'left-3'} absolute mt-8 transition-all duration-300 scale-90 lg:scale-100`}>
        {renderTrash ? 
          ...
          <button className='text-white bg-grayGym px-3 md:px-5 h-[50px] flex justify-center items-center rounded-full hover:text-yellow-500 transition-all duration-300'>
            <h1 className='text-[0px] md:text-[20px]'>Papelera</h1>
            <TiDeleteOutline className=' text-[27px] md:text-2xl md:ml-2'/>
          </button>
          :
